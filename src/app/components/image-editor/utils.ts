...
//   if (imageEditor != null) {
//     const activeObject = imageEditor._graphics.getActiveObject();
//     if (activeObject) {
//       const activeObjectId = imageEditor._graphics.getObjectId(activeObject);
...
//     const parsedR = parseInt(r);
//     const parsedG = parseInt(g);
...
//       g: parsedG,
//       b: parsedB,
//       hexString: `#${(parsedR <= 15 ? '0' : '') + parsedR.toString(16)}${(parsedG <= 15 ? '0' : '') + parsedG.toString(16)
